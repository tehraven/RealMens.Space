    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse hidden">
          <form class="navbar-form navbar-right hidden" role="form">
    ...
    <div class="jumbotron">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <h2>Why</h2>
              <p>Memes need webpages. If I have to tell you why shitty EVE Memes need their own webpages, you are playing the wrong game.</p>
              <p><a class="btn btn-default" href="https://PayPal.Me/tehraven" role="button">Gib Monies</a></p>
            </div>
          </div>
          ...
          <footer>
            <p>Not Copyright, No Year, RaveNight</p>
          </footer>
        </div> <!-- /container -->
